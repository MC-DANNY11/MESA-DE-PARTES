...
if (!empty($_POST['cod']) && !empty($_POST['hasta'])) {
    ...
    try {
        ...
        // Actualizar el libro
        $u_prestamo = "UPDATE tbl_p_material SET fecha_devolucion=? WHERE idPMaterial=?";
        ...
        if ($resultado) {
            ...
            $tblafectada = "Prestamo Material";
            $t_cambio = "Se actualizó fecha de devolución del préstamo del material";
